...
export const PRODUCT_PAGE_META: Record<string, ProductPageMeta> = {
  'soleveil-protect-kpf30': {
    ...
    imageKey: 'soleveil-protect-kpf30',
    galleryKeys: ['soleveil-protect-kpf30'],
  ...
  'silk-shield-spray': {
    ...
    imageKey: 'silk-shield-spray',
    galleryKeys: ['silk-shield-spray'],
    showBeforeAfter: true,
    highlights: [
  ...
  'rituel-cheveux-duo': {
    ...
    savingsPercent: 10,
    imageKey: 'rituel-cheveux-duo',
    galleryKeys: ['rituel-cheveux-duo'],
    showBeforeAfter: true,
    bundleItems: [
      {
